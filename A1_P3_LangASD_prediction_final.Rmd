...
```
Bernie does better than average TD child in all visits except the first one. The absolute distances between Bernie and average TD were the following: -0.0683 (visit1), 0.4054 (visit2), 1.1279 (visit3), 0.8716 (visit4), 0.7755 (visit5), 0.9644 (visit6).
...
```
Bernie's real score on the 6th visit (3.448) is close to the model's predicted value (3.468), although the model slightly overestimates child’s performance.
